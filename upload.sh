...
git push -f https://github.com/Shuaiwen-Cui/LiftHub.git main
# git push -u https://github.com/Shuaiwen-Cui/LiftHub.git main
# git remote add origin https://github.com/Shuaiwen-Cui/LiftHub.git
